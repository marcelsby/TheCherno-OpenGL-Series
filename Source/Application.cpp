...
int main(void)
{
    ...
    // Create a buffer object name (that lives in GPU), and returns a identifier for it.
    ...
    // Tells to the GPU how it must interpret the data that we're passing,
    // in this case 3 vec2 (vectors of two positions), that are the coordinates to our triangle on screen
